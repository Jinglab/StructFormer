...
To use StructFormer, first use the [yaml file](https://github.com/Jinglab/StructFormer/blob/main/StructFormer_env.yml) to create StructFormer Conda environment.
